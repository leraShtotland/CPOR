...
namespace CPOR
{
    ...
    //  public static string BASE_PATH = @"D:\Dropbox\SDR\Deadends";
        ...
        public static string deadEndPath = @"D:\Dropbox\SDR\Deadends\Domains\sokoban\þþþþþþþþprob11Dead.pddl";
        //public static string deadEndPath = @"C:\Users\lera\Desktop\DeadEnds\Domains\sokoban\þþþþþþþþprob11Dead.pddl";

		static void testBFSS()
		{
			String path = @"C:\Users\àáéùé\Dropbox\WriteKPlanner (3)\Example files";
			Domain domain = parser.ParseDomain(path + "Kd.pddl");
			Problem problem = parser.ParseProblem(path + "Kp.pddl", path, domain);
			List<String> res = BFSSolver.ManualSolve(problem, domain, true);
        ...
        class TestBenchmarkThread
        {
            ...
            void TestBenchmark(string sBenchmarkPath, string sBenchmark, int cTrials, bool bWriteResults)
            {
                ...
                try
                {
                    ...
                    //deadEndPath=
                    //Problem problem = parser.ParseProblem(sPath + "þþþþþþprob12oneof.pddl", deadEndPath, domain);
                    // Problem problem = parser.ParseProblem(sPath + "þþþþþþþþþþprob15oneof.pddl", sPath+ "þþþþþþþþþþþþþþprob15Dead.pddl", domain);
                    //Problem problem = parser.ParseProblem(sPath + "þþþþþþþþþþprob14oneof.pddl", sPath+ "þþþþþþþþþþþþprob14Dead.pddl", domain);

                    //Console.WriteLine(sPath + "prob14oneof.pddl");
                    //Problem problem = parser.ParseProblem(sPath + "þþexp2.pddl", sPath + "þþexDead2.pddl", domain);
                   ...
                   // Problem problem = parser.ParseProblem(@"C:\Users\lera\Desktop\p.pddl", @"C:\Users\lera\Desktop\pdead.pddl", domain);
                    ...
                    //Problem problem = parser.ParseProblem(sPath + "þþþþþþprob15oneof.pddl", sPath + "þþþþþþprob15Dead.pddl", domain);
