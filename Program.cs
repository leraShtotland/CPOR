...
namespace CPOR
{
    ...
    //  public static string BASE_PATH = @"D:\Dropbox\SDR\Deadends";
        ...
        public static string ResultsFile = "Results_2.txt";
#if DEBUG
        ...
        */
        ...
        class TestBenchmarkThread
        {
            ...
            void TestBenchmark(string sBenchmarkPath, string sBenchmark, int cTrials, bool bWriteResults)
            {
                ...
                try
                {
                    ...
                    //Domain domain = parser.ParseDomain(@"C:\Users\lera\Desktop\D.pddl");
                     //Domain domain = parser.ParseDomain(sPath + "exd.pddl");
                    ...
                    // Problem problem = parser.ParseProblem(sPath + "‏‏‏‏‏‏‏‏‏‏prob15oneof.pddl", sPath+ "‏‏‏‏‏‏‏‏‏‏‏‏‏‏prob15Dead.pddl", domain);
                    //Problem problem = parser.ParseProblem(sPath + "‏‏‏‏‏‏‏‏‏‏prob14oneof.pddl", sPath+ "‏‏‏‏‏‏‏‏‏‏‏‏prob14Dead.pddl", domain);

                    //Console.WriteLine(sPath + "prob14oneof.pddl");
                    //Problem problem = parser.ParseProblem(sPath + "‏‏exp2.pddl", sPath + "‏‏exDead2.pddl", domain);
                    //Problem problem = parser.ParseProblem(sPath + "results\\8prob.pddl", sPath + "results\\8dead.pddl", domain);
                   // Problem problem = parser.ParseProblem(sPath + "results2\\18prob.pddl", sPath + "results2\\18dead.pddl", domain);
                    //Problem problem = parser.ParseProblem(sPath + "3prob.pddl", sPath + "3dead.pddl", domain);
                   Problem problem = parser.ParseProblem(sPath + "p.pddl", sPath + "dead.pddl", domain);
                   // Problem problem = parser.ParseProblem(@"C:\Users\lera\Desktop\p.pddl", @"C:\Users\lera\Desktop\pdead.pddl", domain);

                    // Problem problem = parser.ParseProblem(sPath + "results\\1prob.pddl", sPath + "results\\1dead.pddl", domain);
                    //Problem problem = parser.ParseProblem(sPath + "results\\17prob.pddl", sPath + "results\\17dead.pddl", domain);
                    //Problem problem = parser.ParseProblem(sPath + "‏‏‏‏‏‏prob15oneof.pddl", sPath + "‏‏‏‏‏‏prob15Dead.pddl", domain);

                    //domain.WriteDeadednDetectionDomain(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.d.pddl", problem);
                    // problem.WriteDeadendDetectionProblem(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.p.pddl");


                    //domain.WriteDeadendDetectionDomain(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\sokoban\results\Trapper.d2_555.pddl", problem);
                    //problem.WriteDeadendDetectionProblem(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\sokoban\results\Trapper.p2_555.pddl");
                    // domain.WriteDeadendDetectionDomain(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\results\Trapper.d1_5.pddl", problem);
                    // problem.WriteDeadendDetectionProblem(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\results\Trapper.p1_5.pddl");

                    //Problem problem = parser.ParseProblem(sPath + "exp1.pddl", sPath + "exDead1.pddl", domain);

                    //Problem problem = parser.ParseProblem(sPath + "p.pddl", sPath + "Dead1.pddl", domain);
        ...
        static void TestAll(string sBenchmarkPath, string[] asBenchmarks, int cTrials, bool bMultiThread)
        {
           // int cMaxThreads = 1;
                ...
                while (i < asBenchmarks.Length)
            {
                ...
                TestBenchmark(sBenchmarkPath, asBenchmarks[i], cTrials, true, bMultiThread);
                //Thread.Sleep(2000); 
                i++; 
        ...
        static void Main(string[] args)
        {
            ...
            //Doors d = new Doors(9, 1);
            //d.WriteProblem("C:\\Users\\lera\\Dropbox\\SDR\\DeadEnds\\Domains\\doors"); 
            ...
            /*
            //guys dropbox path
            string deadEndPath = @"D:\Dropbox\SDR\DeadEnds\Domains\
            \‏‏‏‏‏‏prob10Dead.pddl"; 
          ...
          //  Problem pr = p.ParseProblem(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\p.pddl", deadEndPath,  d);
           ...
           // Problem pr = p.ParseProblem(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\ex_blocksworld\ex_blocksworld_p1.pddl", deadEndPathDrop, d);
            //d.WriteDeadednDetectionDomain(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.d_12_22.pddl", pr);
            //pr.WriteDeadendDetectionProblem(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.p_12_22.pddl");
            ...
            */
            ...
            string[] asBenchmarks = {"sokoban4"

               // "‏‏‏‏‏‏ex_blocksworld27"
               // "ex_blocksworld20"
                //"sokoban4""doors2","doors3","doors4"
                              //  "ex_blocksworld1","ex_blocksworld2", "ex_blocksworld3","ex_blocksworld8","ex_blocksworld10","ex_blocksworld11",
                         // "ex_blocksworld13", "ex_blocksworld14", "ex_blocksworld15", "ex_blocksworld17",  "ex_blocksworld18"
              // "sokoban1","sokoban2","sokoban3","sokoban4","sokoban5","sokoban6","sokoban7","sokoban8",
             //        "sokoban10","sokoban12","sokoban14","sokoban15","sokoban16", "sokoban17"
//"doors1",  "doors1","doors2","doors3","doors4"

                //"ex_blocksworld17", "ex_blocksworld18"
                //"sokoban11"
                //  "sokoban7","sokoban8",

                //"sokoban6""sokoban15",
                // "sokoban7","sokoban8",
                //   "sokoban10","sokoban12","sokoban14","sokoban15",
                //  ,"sokoban17"
                //
                //  "sokoban1","sokoban2","sokoban3","sokoban4","sokoban5",
                //"sokoban1","sokoban2","sokoban3","sokoban4","sokoban5","sokoban6","sokoban7","sokoban8",
                // "sokoban10","sokoban12","sokoban13","sokoban14","sokoban15","sokoban16"
                // ,"sokoban17"
                //      "ex_blocksworld1","ex_blocksworld2", "ex_blocksworld3",

                //"sokoban9","sokoban11"
                //"sokoban","ex_blocksworld"."doors","ctp50", "ctp100",
            ...
            */
            //TestAll(sBenchmarkPath, asBenchmarks, 25, 2);
