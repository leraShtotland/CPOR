...
namespace PDDL
{
    class Program
    {
        public static string BASE_PATH = @"C:\Users\dshemary\Dropbox\SDR\Offline";
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            //Dictionary<Predicate, HashSet<Predicate>> lInvariants = d.IdentifyInvariants(lActions);
            
            /*
                MABlocksWorld w1 = null;
                w1 = new MABlocksWorld(3, 3, 2);
                w1.WriteDomain(sBenchmarkPath + "/" + w1.Name);
                w1.WriteProblem(sBenchmarkPath + "/" + w1.Name);

            Domain d = p.ParseDomain(@"D:\Research\projects\PDDL\CLG_benchmarks\MABlocksWorld-3-3-2\d.pddl");
            Problem pr = p.ParseProblem(@"D:\Research\projects\PDDL\CLG_benchmarks\MABlocksWorld-3-3-2\p.pddl", d);
            List<Action> lActions = d.GroundAllActions(pr);
            Dictionary<Predicate, HashSet<Predicate>> lInvariants = d.IdentifyInvariants(lActions);
 */
 ...
 * */
            ...
            string[] asBenchmarks = { //"sliding-doors-20", //"doors13"
                                        //"Minesweeper",
                                        //"ebtcs-70",
                                        //"localize7",
                                        //"doors11",
                                      ...
                                      // "doors5",
                                       ...
                                       //"Wumpus07", 
                                        //"Wumpus20",
                                        "doors5", 
                                        //"doors9", "doors15","doors9", "doors11", "doors13", 
                                        //"doors15", "doors-17","localize3", "localize5", 
                                        //"localize9","localize11","localize13","sliding-doors-15", 
                                        //"sliding-doors-17","colorballs2-2", "colorballs4-4", 
                                        ...
                                        //"localize5", "Wumpus05", "doors5", "unix2", "elog7"//, "colorballs4-4",
                                         //"colorballs9-1", "colorballs-9-3", "colorballs-9-5","colorballs-9-7",
                                   ...
                                   //     "ebtcs-50",
                                    ...
                                    //   "cballs-4-1",
                                      ...
                                      //  "unix-4",
                                     // "doors5",
                                      //    "RockSample4-2",  "RockSample4-3",  "RockSample8-2",
                    //   "RockSample8-4",  "RockSample8-5",  "RockSample8-6", "RockSample8-7",    "RockSample8-8", "RockSample8-9",   "RockSample8-10", "RockSample8-12", "RockSample8-14",  "RockSample8-16",
                                                                                           
                                        "cballs-4-1",
                                      //"cballs-4-2",  "cballs-4-3",   "cballs-10-1",      "localize5",
                                     //  "localize7",  "localize9",   //     "localize11",                                  //"MasterMind2-4"
                                  "blocks3","blocks7",
             //   "blocks11","blocks15",   "bts10",
                "bts30",                                  "bts50",
                //,"bts70","ebtcs10","ebtcs30","ebtcs50","ebtcs70",
                                  "egrid2","egrid3",
                                  //"egrid4","egrid5",
                                  "logistics1",
                                  //,"logistics3","logistics5","logistics7", "logisticshuge",
                                 "rovers2",
                                 "rovers4",
                                  //"rovers6",  "rovers8" ,"test"
                                    };
            /*
            foreach (string sBenchmark in asBenchmarks)
            {
