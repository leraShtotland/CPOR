        ...
        class TestBenchmarkThread
        {
            ...
            void TestBenchmark(string sBenchmarkPath, string sBenchmark, int cTrials, bool bWriteResults)
            {
                ...
                try
                {
                    ...
                    // Domain domain = parser.ParseDomain(@"C:\Users\lera\Desktop\DeadEnds\Domains\sokoban\d.pddl");
                    ...
                    // Problem problem = parser.ParseProblem(sPath + "prob15oneof.pddl", sPath + "prob15Dead.pddl", domain);
                    Problem problem = parser.ParseProblem(sPath + "‏‏‏‏‏‏prob10oneof.pddl", sPath + "‏‏‏‏‏‏prob10Dead.pddl", domain);
                   ...
                   // problem.WriteDeadendDetectionProblem(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.p.pddl");
                    ...
                    domain.WriteDeadednDetectionDomain(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.d10.pddl", problem);
                    problem.WriteDeadendDetectionProblem(@"C:\Users\lera\Dropbox\SDR\DeadEnds\Domains\sokoban\Trapper.p10.pddl");
          ...
          //  Problem pr = p.ParseProblem(@"D:\Dropbox\SDR\DeadEnds\Domains\sokoban\p.pddl", deadEndPath,  d);
            ...
            */
            ...
            string[] asBenchmarks = {"sokoban",
                                        //"ex_blocksworld"."sokoban","ctp50", "ctp100",
